        ...
        fs.readFile(
            ...
            (error: NodeJS.ErrnoException, data: string) => {
                ...
                const templatePathWithoutFileName = templateFilename
                    ...
                    .replace(/{file}/g, this._options.name);
                ...
                mkdirp(mkdirpPath, () => {
                    ...
                    const fileToWrite = this._options.singleFile
                        ? dest + templateFilename.replace(/{file}/g, this._options.name).split("/").pop()
                        : dest + templateFilename.replace(/{file}/g, this._options.name);
